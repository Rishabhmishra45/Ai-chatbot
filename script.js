...
function handlechatResponse(usermessage) {
    ...
    let html = `<img src="./assets/user2.png" alt="" id="userImage" width="50">
    ...
    setTimeout(() => {
        let html = `<img src="./assets/chat.webp" alt="" id="aiImage" width="50">
            <div class="ai-chat-area">
                <img src="./assets/load.webp" alt="" class="load" width="50px">
            </div>`
